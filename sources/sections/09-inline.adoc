...
** Contains Primary, and optionally Secondary and Tertiary index terms, to be cross-referenced to an alternate index entry, either as "see" or "see also", depending on an `also` attribute
